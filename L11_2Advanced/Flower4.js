...
(function (L11_2_Blumenwiese) {
    class Flower4 extends L11_2_Blumenwiese.Flower {
        ...
        displayNectarLevel() {
            //Nectar
            L11_2_Blumenwiese.showNectar(this.position, Flower4.degree, this.color, "white", this.fps);
        ...
        draw() {
            //drawFlower1
            L11_2_Blumenwiese.drawFlower4(this.position);
        }
    }
    L11_2_Blumenwiese.Flower4 = Flower4;
