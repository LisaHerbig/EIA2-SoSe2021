...
(function (Endaufgabe_FußballSiumulation) {
    ...
    function drawBall(_position) {
        ...
        Endaufgabe_FußballSiumulation.crc2.save();
        Endaufgabe_FußballSiumulation.crc2.beginPath();
        Endaufgabe_FußballSiumulation.crc2.moveTo(_position.x - 3, _position.y - 5);
        Endaufgabe_FußballSiumulation.crc2.lineTo(_position.x - 7, _position.y - 10);
        Endaufgabe_FußballSiumulation.crc2.moveTo(_position.x + 3, _position.y - 5);
        Endaufgabe_FußballSiumulation.crc2.lineTo(_position.x + 7, _position.y - 10);
        Endaufgabe_FußballSiumulation.crc2.moveTo(_position.x + 5, _position.y);
        Endaufgabe_FußballSiumulation.crc2.lineTo(_position.x + 13, _position.y + 2);
        Endaufgabe_FußballSiumulation.crc2.moveTo(_position.x, _position.y + 4);
        Endaufgabe_FußballSiumulation.crc2.lineTo(_position.x, _position.y + 12);
        Endaufgabe_FußballSiumulation.crc2.moveTo(_position.x - 5, _position.y);
        Endaufgabe_FußballSiumulation.crc2.lineTo(_position.x - 13, _position.y + 2);
        //crc2.translate(_position.x, _position.y);
        Endaufgabe_FußballSiumulation.crc2.stroke();
