...
(function (L10_AsteroidsInheritance) {
    ...
    //Implementierung der drei Zeilen aus der Lektion
    let m = new L10_AsteroidsInheritance.Moveable();
    console.log("Moveable m: ", m);
    let a = new L10_AsteroidsInheritance.Asteroid(1);
    console.log("Asteroid a:", a);
    let p = new L10_AsteroidsInheritance.Projectile(new L10_AsteroidsInheritance.Vector(0, 0), new L10_AsteroidsInheritance.Vector(0, 0));
    console.log("Projectile p:", p);
    //Wenn vorangegangenes möglich war, muss das auch möglich sein
    let moveabless = [];
    moveabless.push(new L10_AsteroidsInheritance.Asteroid(1));
    moveabless.push(new L10_AsteroidsInheritance.Projectile(new L10_AsteroidsInheritance.Vector(0, 0), new L10_AsteroidsInheritance.Vector(0, 0)));
    console.log("L10 Übung Array: ", moveabless);
