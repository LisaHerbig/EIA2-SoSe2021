...
(function (L10_2_Blumenwiese) {
    ...
    function drawFlower1(_position, _size) {
        ...
        L10_2_Blumenwiese.drawFlowerStem(_position);
        for (let drawn = 0; drawn < nLeaves; drawn++) {
            ...
            L10_2_Blumenwiese.crc2d.fillStyle = L10_2_Blumenwiese.pinkPurple[L10_2_Blumenwiese.createRandomNum(0, 3)];
    ...
    function drawFlower2(_positionStem, _size) {
        let nLeaves = 5;
        //crc2d.beginPath();
        L10_2_Blumenwiese.drawFlowerStem(_positionStem);
        //crc2d.closePath();
        L10_2_Blumenwiese.crc2d.save();
        let color = L10_2_Blumenwiese.colorfulColors[L10_2_Blumenwiese.createRandomNum(0, 12)];
        for (let drawn = 0; drawn < nLeaves; drawn++) {
            let rotate = 0;
            switch (drawn) {
                case 0:
    ...
    function drawFlower4(_positionStem, _size) {
        ...
        for (let drawn = 0; drawn < nLeaves; drawn++) {
            ...
            L10_2_Blumenwiese.crc2d.fillStyle = L10_2_Blumenwiese.colorfulColors[L10_2_Blumenwiese.createRandomNum(0, 12)];
            L10_2_Blumenwiese.crc2d.closePath();
            //crc2d.scale(_size, _size);
            L10_2_Blumenwiese.crc2d.fill();
            L10_2_Blumenwiese.crc2d.restore();
    ...
    function drawFlower5(_positionStem, _size) {
        ...
        let x = 0;
        let y = 0;
        let randomColor = L10_2_Blumenwiese.createRandomNum(0, 360);
        L10_2_Blumenwiese.drawFlowerStem(_positionStem);
        L10_2_Blumenwiese.crc2d.save();
        for (let drawn = 0; drawn < nLeaves; drawn++) {
            L10_2_Blumenwiese.crc2d.save();
