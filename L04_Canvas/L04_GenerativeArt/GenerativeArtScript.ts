namespace GenerativeArtTSL04 {
    ...
    */
    ...
    function createNumPxCanvas(): number {
        let min: number = 0;
        let max: number = 800;
        let numPxCanvas: number = Math.floor(Math.random() * (max - min + 1)) + min;
        return numPxCanvas;
    }
    ...
    function createFilledCircle(): void {
    ...
    //Cheese Curve
    function createCheeseCurve(): void {
